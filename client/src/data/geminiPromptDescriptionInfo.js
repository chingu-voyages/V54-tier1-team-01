const PROMPTS = {
    ...
    onMountScenarioPrompt: () => { return `
      ...
      Do the step one mentioned above. Present the result in markdown format titling it (h1) "Pentagram Prompting: Learn by Doing through solving an AI-Generated Scenario", a concise introduction of the pentagram framework (no more than 20 words), an scenario section, and a section shortly describing what the student must do and what will happen next. Subtitels of the sections should be always set in (##) markdown.
      `},
